...
from clustering.cluster_identifier import identify_clusters
from clustering.clustering_algorithm import ClusteringAlgorithm
from utils.utils import check_or_create_path
from graph.modeling.graph_utils import graph_from_json
from graph.modeling.plot_graph import plot_graphs_pyvis
from graph.graph import Graph
from clustering.cluster_graph import ClusterGraph

# This class was taken from the original thesis code by Charles Sys, at https://github.com/syscharles/master_thesis_implementation
class AnalysisManager:
    ...
    def save_graph_report(self):
        ...
        graph_info = self.graph_repr.serialize()
    ...
    def save_clusters_report(self):
        ...
        check_or_create_path(directory)
        clusters_info = self.clusters.serialize()
    ...
    def log_clusters_analysis(self):
        ...
        assert isinstance(self.clusters, ClusterGraph), 'Expected clusters to be an instance of ClustersInformation'
        ...
        avg_nodes_clusters_more_than_2 = 0 if more_than_2_nodes <= 1 else total_nodes_clusters_more_than_2 / more_than_2_nodes
        ...
        avg_nodes_clusters_more_than_5 = 0 if more_than_5_nodes <= 1 else total_nodes_clusters_more_than_5 / more_than_5_nodes
    ...
    def run_analysis(self):
        ...
        self.graph_repr = graph_from_json(self.graph_path)
