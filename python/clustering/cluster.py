...
class Cluster:
    def __init__(self, id : int, nodes : list[Node], intra_cluster_edges=list()) -> None:
    ...
    def serialize(self):
        return {
            ...
            "edges": [{"source": edge.source.name, "destination": edge.destination.name} for edge in self.intra_cluster_edges]
        }